...
# 设置路径
INPUT_DIR = "C:/ocr/hanzi/output"  # 原始数据路径
OUTPUT_DIR = "C:/ocr/hanzi/augmented_output"  # 增强后数据存储路径
            ...
            for image_file in os.listdir(char_folder_path):
                ...
                if image_file.endswith((".png", ".jpg", ".jpeg", ".bmp")):
                    ...
                    image.save(os.path.join(
                        output_char_folder, f"orig_{image_file}"))
                    ...
                    for i in range(num_augmentations):
                        ...
                        augmented_image = apply_perspective_transform(
                            stroke_area, jitter=15, min_expand_ratio=0.9, max_expand_ratio=1.1)
                        ...
                        output_image_path = os.path.join(
                            output_char_folder, f"aug_{i}_{image_file}")
