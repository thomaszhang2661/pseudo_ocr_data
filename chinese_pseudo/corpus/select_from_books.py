...
# 输出到文件
with open("xdhy_corpus_book.txt", 'w', encoding='utf-8') as file:
    for x in result_corpus:
        file.write(x + "\n")
with open("result_dict_book.json", 'w', encoding='utf-8') as file:
