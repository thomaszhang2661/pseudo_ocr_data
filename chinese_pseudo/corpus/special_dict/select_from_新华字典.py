...
file_count = "result_dict2.json"
xdhycd = "新华字典_dictionary.json"
pre_dict_file = "xdhy_corpus2_standard.txt"
...
# 输出到文件
with open("新华字典_corpus.txt", 'w', encoding='utf-8') as file:
    for x in result_corpus:
        file.write(x + "\n")
with open("result_dict_新华字典.json", 'w', encoding='utf-8') as file:
