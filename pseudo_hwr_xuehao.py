...
#     output_file = output_path+f'{timestamp}_{text_new}.jpg'
#     larger_image.save(output_file)
#
#
# def process_image_wrapper(args):
#     output_path, text, mnist_data = args
#     create_handwritten_number_image(output_path,text, mnist_data)
#     return output_path
#
# if __name__ == '__main__':
#     random.seed(42)
